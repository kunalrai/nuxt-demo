<template>
  <div class="">
    ...
    <nav class="bg-purple-800 text-white flex justify-between w-auto">
      <img src="https://randomuser.me/api/portraits/women/12.jpg" class="rounded-3xl h-10 p-0 mt-2 ml-2" alt="" />
